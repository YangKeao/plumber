...
use llvm_sys::core::{LLVMBuildAdd, LLVMBuildSub, LLVMBuildMul, LLVMBuildSDiv, LLVMBuildIntCast};
use std::ops::Deref;
...
pub fn evaluate_value<T: IrGen, S: Deref<Target=T>>(ctx: &CompileContext, item: S) -> LLVMValueRef {
